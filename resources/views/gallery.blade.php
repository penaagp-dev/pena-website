    ...
    <div class="card">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <button type="button" class="btn btn-outline-primary ml-auto" data-toggle="modal"
                data-target="#GaleryModel" id="#myBtn">
                Tambah Data
            </button>
        </div>
        <!-- /.card-header -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="GaleryModelLabel">Tambah Data</h5>
                    ...
                    $(document).on('click', '.edit-modal', function() {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $('#jabatan').val(stripHtmlTags(data.data.jabatan));
                                $('#gambar').html(data.data.gambar);
                                $('#preview').attr('src',
                                    "{{ asset('uploads/galery') }}/" +
                                    data.data
                                    .gambar);
